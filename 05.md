...
```jsonc
{
  "pubkey": "npub1kp34665c28f6a5xdd3y4k2ppv7k0wctjjpudja0uxsdjyegtq7us853d4g",
  "kind": 0,
...
{
  "names": {
    "bob": "npub1kp34665c28f6a5xdd3y4k2ppv7k0wctjjpudja0uxsdjyegtq7us853d4g"
  }
}
```
...
```json
{
  ...
  "relays": {
    "npub1kp34665c28f6a5xdd3y4k2ppv7k0wctjjpudja0uxsdjyegtq7us853d4g": [ "wss://relay.example.com", "wss://relay2.example.com" ]
  }
}
```
...
### Public keys must be in npub format

Keys should be returned in NIP-19 `npub` format. Keys may be returned in backwards compatible hex format. 
